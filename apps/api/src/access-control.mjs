...
export const ACCESS_CONTROL_MATRIX = Object.freeze({
  ...
  "organizer-attendees-list": entry({ permission: "organizer.attendees.view", roles: organizerOrPlatform, scope: "event", description: "List attendees for an event", sensitivity: "sensitive" }),
  "organizer-attendees-create": entry({ permission: "organizer.attendees.create", roles: organizerOrPlatform, scope: "event", description: "Register a walk-in attendee", sensitivity: "sensitive" }),
  "organizer-attendees-import": entry({ permission: "organizer.attendees.import", roles: organizerOrPlatform, scope: "event", description: "Bulk import attendees from CSV/XLSX", sensitivity: "sensitive" }),
  "organizer-nfc-batches-create": entry({ permission: "organizer.nfc_batches.create", roles: organizerOrPlatform, scope: "event", description: "Create an NFC tag batch", sensitivity: "internal" }),
  "organizer-nfc-batches-list": entry({ permission: "organizer.nfc_batches.view", roles: organizerOrPlatform, scope: "event", description: "List NFC tag batches for an event", sensitivity: "internal" }),
  "organizer-nfc-batch-uids-add": entry({ permission: "organizer.nfc_batch_uids.add", roles: organizerOrPlatform, scope: "event", description: "Add UIDs to an NFC tag batch", sensitivity: "internal" }),
  "organizer-import-staff-assign": entry({ permission: "organizer.import_staff.assign", roles: organizerOrPlatform, scope: "event", description: "Grant import-staff sub-role to a user", sensitivity: "sensitive" }),
  "organizer-import-staff-revoke": entry({ permission: "organizer.import_staff.revoke", roles: organizerOrPlatform, scope: "event", description: "Revoke import-staff sub-role from a user", sensitivity: "sensitive" }),
